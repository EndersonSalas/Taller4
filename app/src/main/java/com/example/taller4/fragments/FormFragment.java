    ...
    public void setupUI(final View view){
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String strEditName = "User " +editName.getText().toString();
                String strEditLast = "Apellido: " +editLast.getText().toString();
                String strEditEmail = "Email: " +editEmail.getText().toString();
                String strEditPhone ="Teléfono: " + editPhone.getText().toString();
...
//                getActivity().finish();
    ...
    public void enviandoResultado(){
        ...
        bundle.putSerializable("personas", mPersonas);
